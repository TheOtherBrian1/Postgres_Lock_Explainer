<!-- 
	...
	I added my sources, which took quite a bit of time.

	However, this component was coded predominantly by AI. I had originally coded the list version by hand
	and figured I would see what would happen if I fed it to Gemini. To my surprise, it didn't rely on external libraries, 
