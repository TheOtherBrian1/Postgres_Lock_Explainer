    const lockConflicts = [
        ...
        },
        {
            ...
            description: "Prevents schema changes or vacuums from running at the same time on a table. Without it, changes could conflict, corrupt table statistics, and overlapping vacuums would waste resources."
        },
        {
            lock: 'SHARE',
        ...
        },
        {
            ...
            conflicts: ['ROW EXCLUSIVE', 'SHARE UPDATE EXCLUSIVE', 'SHARE ROW EXCLUSIVE', 'SHARE', 'SHARE ROW EXCLUSIVE', 'EXCLUSIVE', 'ACCESS EXCLUSIVE'],
        ...
        },
        {
            ...
            description: "When a table's underlying file is being replaced or its access policies are being updated, Postgres blocks all operations on that table. This prevents data loss during writes and avoids returning incomplete or inconsistent data during reads."
        },
        {
            lock: 'FOR UPDATE',
            conflicts: ['FOR UPDATE', 'FOR SHARE', 'FOR UPDATE', 'FOR NO KEY UPDATE'],
            description: "Blocks rows from being deleted or updated while protected. Also blocks SELECT statements that are modified to be treated as if they were UPDATEs/DELETEs"
        },
        {
