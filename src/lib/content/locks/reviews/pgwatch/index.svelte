<script lang="ts">
	...
	import Review from '$lib/content/locks/reviews/pgwatch/review.svelte';
	import Setup from '$lib/content/locks/reviews/pgwatch/setup.svelte';
</script>
