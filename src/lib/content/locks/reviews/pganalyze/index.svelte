<script lang="ts">
	...
	import ReviewTabGroup from '$lib/components/review_tab.svelte';

	import Review from '$lib/content/locks/reviews/pganalyze/review.svelte';
	import Setup from '$lib/content/locks/reviews/pganalyze/setup.svelte';
</script>
